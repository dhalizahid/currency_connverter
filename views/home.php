                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text white_fonts">
                                        <h4 style="color: yellow;">WellCome To My Website<br><span style="color: yellow;">Now</span>  you can get your services</h4>
                                        <h4>Progress & Success<br><span>Currency</span></h4>
                                        <br>
                                        <a class="start_exchange_bt" href="index.php?view=convert">Start Exchange ></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 layout_padding">
                    ...
                    <div class="full paddding_left_15">
                        <a class="main_bt" href="index.php?view=convert">Exchange ></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12 offset-lg-3">
                    <div class="full">
                        <form class="contact_form_inner" action="controller/contact.php" method="POST" enctype="multipart/form-data">
                            <!-- <fieldset> -->
                                <div class="field">
