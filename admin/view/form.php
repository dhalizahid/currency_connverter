                        ...
                        <div class="card-body card-block">
                            <form action="controller/form.php"  method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="vat" name="symbol" placeholder="Symbol" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="street" class=" form-control-label">Rate</label>
                                    <input type="text" name="rate" id="street" placeholder="Rating" class="form-control">
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="short_name"class=" form-control-label">Short Name</label>
                                        <input type="text" name="short_name" id="city" placeholder="BDT" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <input type="submit"  name="submit" value="Send Data" class="btn btn-primary btn-sm">
